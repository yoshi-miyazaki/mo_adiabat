...
public:
    ...
    const tensor1d<double> getmole() const{return output_mol;};
    const tensor1d<double> getelementcomp() const {return element_mol; };
...
private:
    ...
    tensor1d<double> initial_mol;           // molecule's mol# vector
    tensor1d<double> output_mol;            // element's  mol# vector
    
    tensor1d<double> element_mol;           // Just for now. Not necessary.
};
