/*
  ...
  Revised on 2016/2/25,  2018/7/28
...
initcomp::initcomp(string init_comp, MoleculeData_G& moleculelist){
    /* a reference for list of molecules */
    list_species = moleculelist.getlist();
...
MoleculeData initcomp::read_initcomp(string init_comp){
    ...
    while(!fcomp.eof()){
        ...
        if (s_name == "" or s_name == s_prev){ cout << s_name << endl; break; }
        ...
        // store mol #
        tensor1d<double> temp(numofcomposition);
